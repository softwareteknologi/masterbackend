...
if((isset($_GET['tampil']) ? $_GET['tampil'] : "")=='1')
$angka=isset($_GET['no']) ? $_GET['no'] : "";
else
$angka=$no['id_page']+2;
...
<!-- begin #content -->
		<div id="content" class="content height-full p-0">
		...
		<?php
              ...
              ?>
            <?php
            if($username_user && $isi_text && $id_kategori=='49' && $status=='1'){ ?>
		  <!-- begin mail-box -->
		    <div class="mail-box">
		        ...
		        <div class="mail-box-sidebar dropdown">
		            ...
		            <div class="dropdown-menu email-sidebar" id="email-sidebar" data-scrollbar="true" data-height="100%">
		                ...
		                <div class="mail-box-wrapper">
							...
							?>
                                <li><a href="index.php?menu=interaktif&act=chat&id=<?php echo $baris['id_user']?>">
		                    ...
		                    <table class="table-email">
		                        <tbody>
		                            ...
		                            <tr>
                                        ...
                                        <td class="email-sender">
                                            <a href="index.php?menu=interaktif&act=detail">Facebook</a>
                                       </td>
                                       <td class="email-message">
                                            <a href="index.php?menu=interaktif&act=detail">
                                                <span class="email-title">
                            ...
                            <div data-scrollbar="true" data-height="200px">
                                <ul class="chats">
                                    <li class="left">
                                        ...
                                        <div class="message">
                                            <a href="javascript:;" class="name">Nama User Teman</a>
                                    ...
                                    <li class="right">
                                        ...
                                        <div class="message">
                                            <a href="javascript:;" class="name">Saya</a>
