<?php
		...
		<!-- END query untuk hak akses -->
			...
			<!-- START fitur management project -->
			<?php
            if($username_user && $isi_text && $id_kategori=='51' && $status=='1'){ //BUKA pembagian hak akses ?>
			
		<!-- START tampilan data management project -->
        <div class="row">
                    <div class="col-md-12">
                        <div class="panel pagination-info clearfix m-b-0"><br>
                         <h4 class="form-header">&nbsp Management Project</h4>
						 <?php 
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><?php echo list_tanggal($baris['date_time']);?></td>
                                    ...
                                    <td align="center">
										...
										<form action="proses.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
											...
											<input type="submit" name="hapus_management_project" class="btn btn-danger btn-xs" value="Hapus">
										</form>
                                    </td>
                                </tr>
                                <?php $i++; $count++; } ?>
			...
			<!-- END tampilan data management project -->
                        ...
                        <div class="modal-body">
                            <table class="table table-bordered table-hover">
                              <tbody>
								...
								<tr>
                                  <td class="col-md-1 col-sm-2">Marketing</td>
