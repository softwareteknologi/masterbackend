		        ...
		        <div class="mail-box-sidebar dropdown">
		            ...
		            <div class="dropdown-menu email-sidebar" id="email-sidebar" data-scrollbar="true" data-height="100%">
		                ...
		                <div class="mail-box-wrapper">
							...
							?>
                                <li><a href="index.php?menu=interaktif_alfian&act=chat&id=<?php echo $baris['id_user']?>">
		                    ...
		                    <table class="table-email">
		                        <tbody>
		                            ...
		                            <tr>
                                       ...
                                       <td class="email-message">
                                            <a href="index.php?menu=interaktif_alfian&act=detail">
                                                <span class="email-title">
		                            ...
		                            <tr>
                                        ...
                                        <td class="email-sender">
                                            <a href="index.php?menu=interaktif_alfian&act=detail">Facebook</a>
                                       </td>
                                       <td class="email-message">
                                            <a href="index.php?menu=interaktif_alfian&act=detail">
                                                <span class="email-title">
			            ...
			            <div class="panel-body">
                            <div data-scrollbar="true" data-height="450px">
                                <ul class="chats" id="chats">
									<?php
									$result = mysqli_query($id_mysqli,"SELECT * FROM pesan where id_user='$id1' and chat_group='$id4' group by id_user order by waktu_pesan desc");
