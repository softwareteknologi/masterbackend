...
<!-- Mirrored from seantheme.com/source-admin-v1.3/admin/html/extra_login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Apr 2017 04:19:32 GMT -->
<head>
	<meta charset="utf-8" />
	<title>softek.co.id | Login Page</title>
	...
	<link href="dashboard/assets/plugins/jquery-ui/themes/base/minified/jquery-ui.min.css" rel="stylesheet" />
	<link href="dashboard/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
	<link href="dashboard/assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
	<link href="dashboard/assets/css/animate.min.css" rel="stylesheet" />
	<link href="dashboard/assets/css/style.min.css" rel="stylesheet" />
	<!-- ================== END BASE CSS STYLE ================== -->
    
	<!-- ================== BEGIN BASE JS ================== -->
	<script src="dashboard/assets/plugins/pace/pace.min.js"></script>
	<!-- ================== END BASE JS ================== -->
	
	<!--[if lt IE 9]>
	    <script src="dashboard/assets/crossbrowserjs/excanvas.min.js"></script>
	<![endif]-->
</head>
<body class="pace-top">
	<!-- begin #page-loader -->
	...
	<div id="page-container" class="fade page-container">
		...
		<div class="login">
            ...
            <div class="login-brand bg-inverse text-white">
                <img src="dashboard/assets/img/logo-white.png" height="36" class="pull-right" alt="" /> Login Page
            </div>
		    <!-- end login-brand -->
		    <!-- begin login-content -->
            <div class="login-content">
                <h4 class="text-center m-t-0 m-b-20">Software Teknologi</h4>
	...
	<!-- ================== BEGIN BASE JS ================== -->
	<script src="dashboard/assets/plugins/jquery/jquery-1.9.1.min.js"></script>
	<script src="dashboard/assets/plugins/jquery/jquery-migrate-1.1.0.min.js"></script>
	<script src="dashboard/assets/plugins/jquery-ui/ui/minified/jquery-ui.min.js"></script>
	<script src="dashboard/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
	<!--[if lt IE 9]>
		<script src="dashboard/assets/crossbrowserjs/html5shiv.js"></script>
		<script src="dashboard/assets/crossbrowserjs/respond.min.js"></script>
	<![endif]-->
	<script src="dashboard/assets/plugins/slimscroll/jquery.slimscroll.min.js"></script>
	<script src="dashboard/assets/plugins/jquery-cookie/jquery.cookie.js"></script>
	<!-- ================== END BASE JS ================== -->
	
	<!-- ================== BEGIN PAGE LEVEL JS ================== -->
    <script src="dashboard/assets/js/demo.min.js"></script>
    <script src="dashboard/assets/js/apps.min.js"></script>
	<!-- ================== END PAGE LEVEL JS ================== -->
